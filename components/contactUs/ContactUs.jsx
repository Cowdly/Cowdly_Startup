        ...
        <div className="xl:container mx-auto grid grid-cols-12 items-center mt-24 max-w-6xl max-lg:max-w-3xl rounded-lg orbitron">
            ...
            <div className="hidden lg:block lg:col-span-3    mt-8 ">
                ...
                <div className="mb-6 text-center lg:text-left">
                    ...
                    <p className="text-right font-semibold">+1 (833) 520-3712</p>
                </div>
                <div className="text-center lg:text-left">
                    <h4 className="text-right text-[#898989] text-[16px] font-semibold">البريد الالكتروني</h4>
                    <p className="text-right font-semibold">Hello@conceptsoftworks.com</p>
                </div>
            </div>
            ...
            <div className="lg:col-span-9 col-span-12 w-full items-center gap-14 sm:p-8 p-4 font-sans text-end">
                <div className="">
                    <h1 className="text-3xl text-[#5665AE] text-[28px] lg:text-[58px] font-semibold leading-[42px] lg:leading-[58px] pb-5">تواصل معنا</h1>
                    ...
                    <form>
                        <div className="space-y-4 mt-8 t">
                            <input type="text" placeholder="Full Name" className="text-right text-xl px-2 py-3 bg-white w-full text-gray-800 border-b border-gray-300 focus:border-blue-600 outline-none" />

                            <input type="email" placeholder="Email" className="text-right text-xl px-2 py-3 bg-white w-full text-gray-800 border-b border-gray-300 focus:border-blue-600 outline-none" />

                            <textarea placeholder="Project details" className="text-right text-xl px-2 pt-3 bg-white w-full text-gray-800 border-b border-gray-300 focus:border-blue-600 outline-none"></textarea>
                        </div>
