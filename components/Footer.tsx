        ...
        <div className="max-w-screen-xl  py-16 mx-auto relative z-50 ">
          <div className="grid grid-cols-1 gap-20 lg:grid-cols-12 items-end">
            ...
            <div className="lg:col-span-6 w-full ">
              ...
              />
              <br></br>
              <p className="float-right w-[80%] mt-4 text-sm text-white leading-[36px]  text-[17px] font-medium tracking-widest text-end	">
                كودلي كودلي كودلي كودلي كودلي كودلي كودلي كودلي كودلي كودلي
                كودلي كودلي كودلي كودلي كودلي كودلي كودلي كودلي كودلي كودلي
                كودلي كودلي كودلي كودلي كودلي
              </p>
            </div>
          </div>
        </div>
